...
namespace MVCMyProject
{
    ...
    public class ApplicationUserManager : UserManager<Client>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Client>(UnitOfWork.Create()));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<Client>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<Client>
            {
